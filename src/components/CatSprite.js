...
export default function CatSprite({ parentDivRef }) {
  ...
  return (
    <>
      <div
        className={`bg-red-100 inline-block relative ${
          looksData.isShowed ? "visible" : "hidden"
        }`}
        draggable={true}
        style={{
          transition: `transform ${motionData.time}s`,
          transform: `translate(${motionData.x}px, ${motionData.y}px) rotate(${motionData.degree}deg) `,
          filter: "url(#brightnessFilter)",
          opacity: `${looksData.ghost}`,
        }}
      >
        <Msg />
        <svg
          ...
          width={looksData.size}
          height={looksData.size}
        ...
        >
          <filter id="brightnessFilter">
            <feComponentTransfer>
              <feFuncR type="linear" slope={looksData.brightness} />
              <feFuncG type="linear" slope={looksData.brightness} />
              <feFuncB type="linear" slope={looksData.brightness} />
            </feComponentTransfer>
          </filter>
              ...
              <g id="costume1">
                <g id="costume1.1">
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    // style={{transform:'translate(6px,-4px) rotate(9deg)'}}
                  />
                  <path
